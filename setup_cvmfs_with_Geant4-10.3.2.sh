...
export GEANT4_VERSION=4.10.03.p02
export GEANT4_VERSION_STR=4_10_03_p02
# export GEANT4_VERSION=4.10.05.p01
# export GEANT4_VERSION_STR=4_10_05_p01
...
#export LD_LIBRARY_PATH=/cvmfs/dampe.cern.ch/centos7/opt/conda/lib/:/cvmfs/dampe.cern.ch/centos7/lib:/cvmfs/dampe.cern.ch/centos7/lib64:/cvmfs/dampe.cern.ch/centos7/opt/rh/devtoolset-4/root/usr/lib:/cvmfs/dampe.cern.ch/centos7/opt/rh/devtoolset-4/root/usr/lib64
...
# adding Geant4
cd ${cvbase}/opt/geant4.10.03p02/share/Geant4-10.3.2/geant4make
