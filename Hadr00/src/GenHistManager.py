...
middle = "const G4ParticleDefinition* particle = G4IonTable::GetIonTable()->GetIon(3, 6, 0);".format(protons,neutrons)
Content = part1 + middle + part2

with open('HistoManager.cc', 'w') as outfile:
